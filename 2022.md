...
1. [Chain-of-Thought Prompting Elicits Reasoning in Large Language Models](https://arxiv.org/abs/2201.11903v6), Jason Wei,Xuezhi Wang,Dale Schuurmans,Maarten Bosma,Brian Ichter,Fei Xia,Ed Chi,Quoc Le,Denny Zhou, 28-01-2022
      ### Categories
...
1. [Out of One, Many: Using Language Models to Simulate Human Samples](https://arxiv.org/abs/2209.06899v1), Lisa P. Argyle,Ethan C. Busby,Nancy Fulda,Joshua Gubler,Christopher Rytting,David Wingate, 14-09-2022
      ### Categories
    ...
    * We propose that language models can be studied as effective proxies for specific human sub-populations in social science research

    * Algorithmic bias within the GPT-3 language model is both fine-grained and demographically correlated, allowing proper conditioning to accurately emulate response distributions from a wide variety of human subgroups

    * This property, known as algorithmic fidelity, is explored through the creation of "silicon samples" by conditioning the model on thousands of socio-demographic backstories from real human participants in multiple large surveys conducted in the United States

    * This information is nuanced, multifaceted, and reflects the complex interplay between ideas, attitudes, and socio-cultural context that characterize human attitudes

    * This tool can advance understanding of humans and society across a variety of disciplines.
